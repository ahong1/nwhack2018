...
class SlowDown extends Component {
  ...
  render() {
    return (
      <Banner duration={5000} entryAnimation={animation.PAN_DOWN} exitAnimation={animation.PAN_DOWN}
              styles={{zIndex: 999, backgroundColor: 'black'}} onAlertEnd={this.props.onAlertEnd}>
          <h1 className="speed-header">SLOW</h1>
          <h1 className="speed-header">DOWN</h1>
      </Banner>
    );
  }
}
